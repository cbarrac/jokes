...
if ( process.argv[ 2 ] && process.argv[ 3 ] ) {
  ...
  fs.readFile(inFile, function(err,data) {
    ...
    console.info("Input file is %s Bytes, this will generate %s commits and take approximately %s hours %s minutes %s seconds", length, commit_count, commit_time_hour, commit_